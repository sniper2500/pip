/*
  # Pipe & Excavation Calculator Database Schema
...
-- Create policies for project_parameters
CREATE POLICY "Users can view own project parameters"
  ON project_parameters
  FOR SELECT
  TO authenticated
  USING (
    project_id IN (
...
-- Create policies for project_structures
CREATE POLICY "Users can view own project structures"
  ON project_structures
  FOR SELECT
  TO authenticated
  USING (
    project_id IN (
...
-- Create policies for surveyor_info
